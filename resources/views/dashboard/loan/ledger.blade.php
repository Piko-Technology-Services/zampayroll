...
.llg {
    ...
    --active: #2F6F4E; --active-bg: #EAF3EC; --warn: #9B3A2A; --warn-bg: #F7E7E2;
    --sick: #B5651D; --sick-bg: #FBEEE0;
...
.llg-eyebrow { font-family: 'Roboto Slab', serif; font-size: .68rem; font-weight: 600; letter-spacing: .14em; text-transform: uppercase; color: var(--brass); margin-bottom: .2rem; }
.llg-title { font-family: 'Roboto Slab', serif; font-size: 1.4rem; font-weight: 700; margin: 0; }
...
.llg-summary-label { font-family: 'Roboto Slab', serif; font-size: .64rem; font-weight: 600; text-transform: uppercase; letter-spacing: .06em; color: var(--ink-faint); margin-bottom: .4rem; }
.llg-summary-value { font-family: 'IBM Plex Mono', monospace; font-size: 1.15rem; font-weight: 600; color: var(--ink); }
...
.llg-tab-count { font-family: 'IBM Plex Mono', monospace; font-size: .66rem; background: rgba(0,0,0,.08); padding: .05rem .4rem; border-radius: 10px; }
...
.llg-table thead th { font-family: 'Roboto Slab', serif; font-size: .64rem; font-weight: 600; color: var(--ink-faint); text-transform: uppercase; letter-spacing: .06em; padding: .8rem 1rem; border-bottom: 2px solid var(--ink); text-align: left; background: #FCFBF8; }
...
.llg-mono { font-family: 'IBM Plex Mono', monospace; }
.llg-balance { font-weight: 700; }
.llg-emp-name { font-weight: 600; font-size: .82rem; }
.llg-emp-id { font-family: 'IBM Plex Mono', monospace; font-size: .66rem; color: var(--ink-faint); }
...
.llg-status-completed { background: #EAEEF4; color: #35507A; }
